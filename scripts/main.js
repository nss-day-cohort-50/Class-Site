...
function cohortMembers(list) {
  ...
  data.forEach(function (item) {
    ...
    let studentInfo = `<div class="col-md-3 cohortMems">
          <div class="studentphotos"><img class="card-img-top" src="images/classmates/${item.proImg}" alt="${item.firstName} ${item.lastName}" data-toggle="modal" data-target="#cohortMember${item.id}" style="cursor:pointer;"></div>
          <div class="card-body">
